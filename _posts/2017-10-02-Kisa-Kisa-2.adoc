...
Bu şarkıyı bugün duydum bir yerlerden sesi geliyordu; sözleri başlayıncaya kadarki ezgi hüznü getirmeye, gözlerimi doldurmaya yetti. Sözleri anlamını terk etti. Karşıma sizi getirdi işte. Aklımdasınız, gelin görün ki rahatsızlığınıza tek bir faydam yok. Gönlümde duam var sadece.Keşke ah keşke dedim durdum, devamını getiremedim. Ne gelir onu da bilmiyorum ki...

Sözlerinden cımbızlayıp şu cümle ile bitireyim: _"Çok severim söylemem"_

video::3VFQ-Al7qz8[youtube]
