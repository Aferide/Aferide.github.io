...
"Şimdi bir hanımefendinin biyografisini okuyorum. Ailecek sabah namazına kalkıyorlar, çocuğun yaşı dört. Namazdan sonra yatılmıyor, peder Kur'an okuyor, dinliyorlar, sonra ilmihal bilgisi veriliyor. Kahvaltı yapılıyor, gün başlıyor."

Yuvamızda bir benzerini yapmayı ne çok istedim. Hiç değilse ayda bir gün. Meleğim ve yavrularımızla.

✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿✿

_O duymasın, onun için yaşayım_ +
_Onun için denizleri aşayım_
